            ...
            List<ManagerNewsSearchRespone> managerNewsSearchResponeList =
                    jdbcTemplate.query(
                            ...
                            (rs, rowNum) -> ManagerNewsSearchRespone.
                                    ...
                                    .timeUpTopStart((rs.getString("timeUpTopStart")) == null ? null : LocalDateTime.parse(rs.getString("timeUpTopStart"), dateTimeFormatter))
                                    .timeUpTopEnd((rs.getString("timeUpTopEnd")) == null ? null : LocalDateTime.parse(rs.getString("timeUpTopEnd"), dateTimeFormatter))
                                    .statusUpTop(rs.getLong("statusUpTop"))
                                    .build()
                    );
